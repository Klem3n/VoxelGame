...
public class BlockSpruceWood extends Block {
    public BlockSpruceWood() {
        super(BlockID.SPRUCE_WOOD, "Spruce wood block", true, 1f);
    ...
    public int render(float[] verticies, int vertexOffset, Chunk chunk, int x, int y, int z, byte faceMask) {
        return DefaultBlockRenderer.render(verticies, vertexOffset, chunk, 21, 116, 21, getAlpha(), x, y, z, faceMask, true);
    }
